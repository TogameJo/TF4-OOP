...
<header class="header fixed">
    <div class="main-content">
        <div class="body">
            ...
            <script>
                let Manamenu = document.getElementById("Manamenu");
                function toggleMana(){
                    Manamenu.classList.toggle("open-wrap");
                }
            </script>
            </nav>
            <!-- btn -->
            <div class="action">
                <div>
                    <img src="images/liam.avif" alt="avt" class="admin-main-avatar" onclick="toggleMenu()">
                </div>
                <div class="sub-menu-wrap" id="Submenu">
                    <div class="sub-menu">
                        <div class="user-info">
                            <img class="user-pics-info" src="images/liam.avif" alt="avt">
